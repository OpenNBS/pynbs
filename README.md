...
from [Open Note Block Studio](https://hielkeminecraft.github.io/OpenNoteBlockStudio/nbs). Compatible with
python 2 and 3.
...
NOTE: This library has been updated to work with songs generated by [Open Note Block Studio](https://hielkeminecraft.github.io/OpenNoteBlockStudio/). Make sure your songs were saved in version 3.6.0 or greater, otherwise they will no longer be compatible.
...
:---------------------------|:--------|:------------------------------------------------
`header.version`            | `int`   | The NBS format version. This module only supports version 3.
...
> For more information about all these fields, check out the [official specification](https://hielkeminecraft.github.io/OpenNoteBlockStudio/).
